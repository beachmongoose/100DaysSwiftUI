      ...
      VStack(spacing: 30) {
        ...
        ForEach(0..<3) { number in
          Button(action: {
            ...
            let text = self.labels[self.countries[number], default: "Unknown flag"]
            FlagImage(text: text, image: self.countries[number])
          }
        }
...
struct FlagImage: View {
  ...
  var body: some View {
    ...
    // Accessibility modifier
      .accessibility(label: Text(text, default: "Unknown flag"]))
    }
  }
